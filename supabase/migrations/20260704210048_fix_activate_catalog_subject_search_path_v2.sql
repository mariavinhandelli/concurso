-- v2: a migration anterior escreveu o search_path como a STRING literal
-- 'public, pg_temp' (um único identificador entre aspas) em vez de dois
-- identificadores. Aqui vai sem aspas, como lista de verdade.
