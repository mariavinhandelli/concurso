...
const s: Record<string, CSSProperties> = {
  ...
  badge: { fontSize: 10, fontWeight: 700, letterSpacing: 0.3, textTransform: 'uppercase', color: theme.tealDeep, background: theme.tealBg, padding: '1px 6px', borderRadius: theme.radiusPill, flexShrink: 0 },
