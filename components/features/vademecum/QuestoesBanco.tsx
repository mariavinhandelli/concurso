...
const s: Record<string, CSSProperties> = {
  ...
  progressoTexto: { fontSize: 14, color: theme.inkSoft },
  ...
  ctrlLabel: { fontSize: 13, color: theme.inkFaint, minWidth: 58 },
  chip: { fontSize: 12, color: theme.inkSoft, background: 'transparent', borderWidth: 0.5, borderStyle: 'solid', borderColor: theme.line, borderRadius: theme.radiusPill, padding: '4px 12px', cursor: 'pointer', fontFamily: 'inherit' },
  ...
  artChip: { fontSize: 12, fontWeight: 700, color: theme.tealDeep, background: theme.tealBg, border: 'none', borderRadius: theme.radiusPill, padding: '3px 10px', cursor: 'pointer', fontFamily: 'inherit' },
