...
const s: Record<string, CSSProperties> = {
  ...
  footBtnOn: { border: `0.5px solid ${theme.teal}`, color: theme.tealDeep, background: theme.tealBg },
  ...
  corBtn: { width: 22, height: 22, borderRadius: 7, border: `0.5px solid ${theme.line}`, boxSizing: 'border-box', cursor: 'pointer' },
