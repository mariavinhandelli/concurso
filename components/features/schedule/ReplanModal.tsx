...
export function ReplanModal({ moves, applying, onConfirm, onClose }: Props) {
  return (
    <Overlay onClose={onClose} maxWidth={480} labelledBy="replan-modal-title">
      <h2 id="replan-modal-title" style={s.h2}>Reorganizar a semana</h2>
        <p style={s.sub}>
...
const s: Record<string, React.CSSProperties> = {
  ...
  sub: { fontSize: 14, color: theme.inkSoft, margin: '6px 0 16px', lineHeight: 1.5 },
  ...
  nome: { fontSize: 14, fontWeight: 600, color: theme.ink, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' },
  topico: { fontSize: 12, color: theme.inkFaint, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' },
