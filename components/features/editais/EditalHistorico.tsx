...
export function ConcursoStatsTable({ stats }: { stats: ConcursoStat[] }) {
  // Só ano, vagas e inscritos — nota de corte e nomeados saíram em 31/07:
  // curadoria cara demais para manter honesta (ficavam em "—" na maioria das
  // linhas). Coluna 100% vazia também sai: melhor mostrar só o que existe.
  const has = {
  ...
  return (
    <div className="table-scroll" style={{ marginTop: 12 }}>
      <table style={s.table}>
        <caption style={s.srOnly}>Histórico do concurso por ano: vagas e inscritos</caption>
        <thead>
          <tr>
