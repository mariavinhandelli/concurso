// app/(app)/progresso/historico/page.tsx — aba HISTÓRICO (M1).
...
// O YearHeatmap saiu daqui para o topo da aba Evolução (é retrato de identidade,
// não um detalhe do histórico); header/container vêm do layout de /progresso.
'use client';
...
export default function HistoricoPage() {
  ...
  return (
    // Largura de leitura preservada dentro do container wide do layout —
    // lista de sessões esticada a 1080px vira linha ilegível.
    <div style={{ maxWidth: 720, minWidth: 0 }}>
      {dialog}
      <p style={styles.lead}>Suas sessões de estudo, dia a dia. Toque numa sessão para ver os detalhes.</p>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  lead: { fontSize: 14, color: theme.inkSoft, fontWeight: 500, margin: '0 0 18px', lineHeight: 1.5 },
