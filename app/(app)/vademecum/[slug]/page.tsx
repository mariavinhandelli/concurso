...
const s: Record<string, CSSProperties> = {
  ...
  stat: { fontSize: 12.5, color: theme.inkSoft, background: theme.card, border: `0.5px solid ${theme.line}`, borderRadius: 999, padding: '5px 12px' },
  ...
  jumpInput: { width: 110, boxSizing: 'border-box', padding: '7px 10px', borderRadius: 999, borderWidth: 0.5, borderStyle: 'solid', borderColor: theme.line, background: theme.card, fontSize: 13, color: theme.ink, fontFamily: 'inherit', outline: 'none', marginBottom: 6 },
  legenda: { display: 'flex', flexWrap: 'wrap', gap: 8, alignItems: 'center', marginBottom: 14 },
  legHint: { fontSize: 12.5, color: theme.inkFaint },
  legChip: { display: 'inline-flex', alignItems: 'center', gap: 5, fontSize: 12, color: theme.inkSoft, background: 'transparent', border: `0.5px solid ${theme.line}`, borderRadius: 999, padding: '4px 10px', cursor: 'pointer', fontFamily: 'inherit' },
  ...
  filtroVazio: { fontSize: 13.5, color: theme.inkFaint, textAlign: 'center', padding: '30px 0' },
