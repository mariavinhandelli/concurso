...
const s: Record<string, CSSProperties> = {
  ...
  btnC: { flex: 1, padding: '13px 0', borderRadius: theme.radiusSm, border: `1.5px solid ${theme.ok}`, background: 'transparent', color: theme.ok, fontSize: 14.5, fontWeight: 700, cursor: 'pointer', fontFamily: 'inherit' },
  btnE: { flex: 1, padding: '13px 0', borderRadius: theme.radiusSm, border: `1.5px solid ${theme.danger}`, background: 'transparent', color: theme.danger, fontSize: 14.5, fontWeight: 700, cursor: 'pointer', fontFamily: 'inherit' },
  resultado: { fontSize: 13.5, fontWeight: 600, borderRadius: theme.radiusSm, padding: '10px 14px', marginBottom: 10 },
  ...
  evolucaoPct: { fontSize: 10.5, color: theme.inkFaint, fontWeight: 600 },
